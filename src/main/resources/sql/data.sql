--- Insert data into hospital table and get generated IDs
INSERT INTO hospital (established_date, hospital_address, hospital_name)
VALUES
...
INSERT INTO hospital_departments (hospital_id, departments)
VALUES
    (1, 'CARDIOLOGY'),
    (1, 'NEUROLOGY'),
    (2, 'SURGERY'),
...
INSERT INTO patients (admission_date, age, billing_amount, hospital_id, first_name, gender, last_name, patient_id)
VALUES
    ('2023-07-14', 45, 5000.00, 1, 'George', 'MALE', 'Anderson', 'P001'),
    ('2023-06-30', 30, 3000.00, 1, 'Hannah', 'FEMALE', 'Baker', 'P002'),
    ('2023-05-21', 60, 7000.00, 2, 'Ian', 'MALE', 'Clark', 'P003'),
    ('2023-09-10', 25, 2500.00, 2, 'Julia', 'FEMALE', 'Diaz', 'P004'),
    ('2023-08-05', 10, 1500.00, 3, 'Kevin', 'MALE', 'Evans', 'P005'),
    ('2023-07-25', 35, 4000.00, 3, 'Laura', 'FEMALE', 'Foster', 'P006');


-- Insert data into medical_record table
INSERT INTO medical_record (doctor_license_number, treatment_date, diagnosis, patient_patient_id, treatment)
VALUES
